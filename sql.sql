...
CREATE DATABASE IF NOT EXISTS `id21435490_localhost` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `laravel`;
...
INSERT INTO `users` (`id`, `name`, `position`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Petry Cintra Amaral', 'Gerente', 'petry@regponto.com', '2023-10-19 01:22:00', '$2y$10$Ezc.rYxspHMZejJ/jrvO9.ibSmmrX2Y8viGoQB2V0WAqHxeI3Spt.', 'u843USsj6b5NDIu96FZ3zfZWwUlGzu2JTe3uYYOQfkfSoJU8rDPbBVuEuq1o', '2023-10-19 01:22:00', '2023-10-21 03:41:33'),
	(2, 'Julie Hevellyn de Oliveira', 'Jornalista', 'julie@regponto.com', '2023-10-19 01:22:00', '$2y$10$U8/Qf0I.jguLDR2cTUUZ1uBb/4GXvAjnioYigTsLY0eHb61Oj1xvu', 'WoRj6aF3rLV9rEosUWy4xs2gQ5wGyBuY5cQKZc2Tp3JkW7Ou7lbG2lToLcIe', '2023-10-19 01:22:00', '2023-10-21 04:09:51'),
